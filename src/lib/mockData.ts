...
export const mockTasks: Task[] = [
  { id: "t1", title: "بررسی اسناد گمرکی LS-9803", description: "مدارک ترخیص هنوز تکمیل نشده است.", assignedToUserId: "u3", assignedToName: "محمد تهرانی", assignedByName: "علیرضا احمدی", status: "TODO", priority: "HIGH", dueDate: "1403/02/01", shipmentId: "s3", createdAt: "1403/01/25" },
  { id: "t2", title: "هماهنگی با راننده برای LS-9804", description: "کالای ترخیص شده نیاز به ارسال فوری دارد.", assignedToUserId: "u3", assignedToName: "محمد تهرانی", assignedByName: "سارا رضایی", status: "IN_PROGRESS", priority: "URGENT", dueDate: "1403/02/02", shipmentId: "s4", createdAt: "1403/01/26" },
  { id: "t3", title: "تایید فاکتور انبارداری", description: "فاکتورهای مربوط به ماه فروردین بررسی شود.", assignedToUserId: "u4", assignedToName: "نازنین حسینی", assignedByName: "علیرضا احمدی", status: "DONE", priority: "MEDIUM", dueDate: "1403/01/30", createdAt: "1403/01/20" },
];
